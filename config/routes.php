...
$routes->scope('/', function (RouteBuilder $builder) {
    ...
    $builder->connect('/posts/edit', ['controller' => 'Posts', 'action' => 'edit']);
    $builder->connect('/posts/delete', ['controller' => 'Posts', 'action' => 'delete']);
    $builder->connect('/posts/search', ['controller' => 'Posts', 'action' => 'search']);
    ...
    $builder->connect('/users', ['controller' => 'Posts', 'action' => 'index']);
    $builder->connect('/users/forgotpassword', ['controller' => 'Users', 'action' => 'forgotpassword']);
    $builder->connect('/users/resetpassword', ['controller' => 'Users', 'action' => 'index']);
